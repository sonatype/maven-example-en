...
[[fig-go-into-control-panel]]
.Go into the Control Panel
image::figs/web/installation_set_env_var_1.png[]

* Open System
[[fig-open-system]]
.Open System
image::figs/web/installation_set_env_var_2.png[]

* Go in Advanced tab and click on Environment Variables.
[[fig-click-on-env-var]]
.Go in Advanced tab and click on Environment Variables
image::figs/web/installation_set_env_var_3.png[]

* Click on New (the lower in the System variables section).
[[fig-click-on-new]]
.Click on New (the lower)
image::figs/web/installation_set_env_var_4.png[]

* Fill in the fields with +M2_HOME+ and 'c:\Program Files\apache-maven-3.0.3' and click on OK button.
[[fig-fill-in-the-fields]]
.Fill in the fields with +M2_HOME+ and 'c:\Program Files\apache-maven-3.0.3' and click OK.
image::figs/web/installation_set_env_var_5.png[]

* Click on the Path variable in the System variables section and click on Edit button.
[[fig-click-path-variable]]
.Click on the Path variable in the System variables section and click on Edit button.
image::figs/web/installation_set_env_var_6.png[]

* Add this string in the Variable value field: +;%M2_HOME%\bin+ and click on OK button.
[[fig-add-path-variable]]
.Add this string in the Variable value field: +;%M2_HOME%\bin+ and click on OK button.
image::figs/web/installation_set_env_var_7.png[]

* Click on OK button.
[[fig-click-ok-env]]
.Click on OK button.
image::figs/web/installation_set_env_var_8.png[]

* Click on OK button.
[[fig-click-ok-sys]]
.Click on OK button.
image::figs/web/installation_set_env_var_9.png[]
